...
describe("MeetingControls", () => {
    it("renders mute and leave actions", () => {
        ...
        const onLeave = vi.fn();
        render(_jsx(MeetingControls, { isMuted: false, isVideoEnabled: true, preferredLanguage: "en", onToggleMute: onToggleMute, onToggleVideo: onToggleVideo, onLanguageChange: onLanguageChange, onLeave: onLeave }));
