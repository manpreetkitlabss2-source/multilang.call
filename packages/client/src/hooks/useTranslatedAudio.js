...
const base64ToArrayBuffer = (audioBase64) => {
...
export const useTranslatedAudio = (socket) => {
    ...
    useEffect(() => {
        ...
        const handleTranslationStatus = (payload) => {
            setStatus("translating");
            setTranscript(payload.transcript);
        };
        const handleTranslatedAudio = async (payload) => {
            setStatus("ready");
            ...
            try {
                ...
                const audioBuffer = await context.decodeAudioData(base64ToArrayBuffer(payload.audioBase64));
